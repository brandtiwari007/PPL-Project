...
const Timeline = props => {
  ...
  const handleImg = value => {
    ...
    props.history.push({ pathname: "/singlepost", state: { ...value } });

    console.log("in po", props);
  };

  const getPost = () => {
    Axios.post("http://localhost:8969/getImage", adddata).then(response => {
      if (response.data) {
        // this.setState({
          ...
          <div className="content">
            <div className="content_rgt">
              ...
              <div className="rght_btn">
                ...
                <Link to="#" onClick={addCategory1}>
                  Add Categories
                </Link>
                {adddata.cat ? (
                  <AddCategory
                    changeCatState={() => setdata({ ...adddata, cat: false })}
                          ...
                          <ul>
                            ...
                            <li>
                              ...
                              <div className="div_name3">
                                {adddata.count ? (
                                  <Upload changeCount={changeCount} />
                                ) : null}
                  ...
                  return (
                    <div className="contnt_2">
                      <div className="div_a">
                        ...
                        >
                          <img
                            src={"http://127.0.0.1:8969/uploads/" + value.image}
                          />
                          {/* 
