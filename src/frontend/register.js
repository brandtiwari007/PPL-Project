...
event.preventDefault()
    axios.post("http://localhost:8969/signup",this.state)
    .then((response)=>{
            ...
            <div className="content_rgt">
              <div className="register_sec">
                ...
                <ul>
                  ...
                  <li><span>Username</span><input type="text"  name="username" onChange={this.handleusername}     placeholder="Enter your username"  required /></li>
                  <li><span>Password</span><input type="password" required name="password" onChange={this.handlepassword} placeholder="Enter your password" /></li>
                  <li ><span >Email</span><input type="email"  required name="email" onChange={this.handleemail} placeholder="Enter your email"  />
                  
                        <span > {this.state.err} </span>
                  </li>
                  <li><span>First Name</span><input  name="firstname" required onChange={this.handlefirstname} type="text" placeholder="Enter your first name" /></li>
                  <li><span>Last Name</span><input name="lastname" required onChange={this.handlelastname} type="text" placeholder="Enter your last name" /></li>
                  <li><input type="checkbox" />I agree to Term &amp; Conditions</li>
                  <li><input type="submit" required   defaultValue="Register" /></li>
                  </form>
                  <span>{this.state.responsegive}</span>
